...
#9 - Faça um programa que utilize 4 variáveis como preferir e, no final, exiba uma mensagem amigável utilizando as variáveis criadas. Exemplos de variáveis: nome, idade, lugar, profissão. Exemplo de retorno: "Olá Maria, prazer te conhecer. Sou de São Paulo também e estou migrando de área."
